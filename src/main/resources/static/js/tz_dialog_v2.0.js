$.tzDialog = function(opts){
	...
	var $dialog = $("<div class='tz_dialog "+animate_r+"'>"+
					...
					"		</div>"+
					"		<div class='t_content'>"+
					"        <label style='margin-left:50px;margin-top:5px;'>微信支付<input id='wx' type='checkbox'/></label>    <label style='margin-left:30px;margin-top:5px;'>银行转账<input id='yh' type='checkbox'/></label>"+
					"			<div class='t_message'>"+
