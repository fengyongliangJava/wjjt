...
function countOwe() {
    ...
    var formData = new FormData($('#countOweForm')[0]);

    $.ajax({
        cache: false,
        type: "POST",
        url: prefix + '/getCountOwe',
        data : formData,
        async: false,
        processData: false,
        contentType: false,
                ...
                series: [
                    {
                        ...
                        data:[
                                ...
                                label: {
                                    normal: {
                                        formatter: [
                                            ...
                                            '  {weatherHead|类型}{valueHead|户数}{rateHead|金额}',
                                            '{hr|}',
                                            '  {Cloudy|}{value|'+data.elecCount+'}{rate|'+data.elecSum+'}',
                                            '  {Sunny|}{value|'+data.waterCount+'}{rate|'+data.waterSum+'}',
                                            '  {Showers|}{value|'+data.heatCount+'}{rate|'+data.heatSum+'}'
                                        ].join('\n'),
                                        backgroundColor: '#eee',
                                        borderColor: '#777',
                                        borderWidth: 1,
                            ...
                            {value:data.heatSum, name:'暖费'},
                            {value:data.waterSum, name:'水费'}
                        ],
                        itemStyle: {
                            emphasis: {
                                shadowBlur: 10,
...
function exportOwe(){
    ...
    window.location.href = prefix + '/exportOwe?createTime='+createTime+'&userOrg='+userOrg+'&userType='+userType+'&userId='+userId;
    	LoadingClose();
}
