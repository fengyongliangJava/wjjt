...
public class ExportExcelSheet {
    ...
    //构造方法2，传入要导出的数据
    public ExportExcelSheet( String sheettitle, String oneheaders,  String[] rowName,List<Object[]> dataList){
    ...
    public void export(HSSFWorkbook workbook,OutputStream out) throws Exception{
        try{
            ...
            cellTiltle.setCellValue(oneheaders);
            ...
            for(int i=0;i<dataList.size();i++){
                ...
                HSSFRow row = sheet.createRow(i+2);//创建所需的行数（从第二行开始写数据）
